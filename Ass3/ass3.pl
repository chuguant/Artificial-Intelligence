...
agent_cycle(N, Intentions, Intentions3) :-
  N = 2,
    ...
    write('  Event: stone appears at '), write('('), write(4), write(','), write(3), writeln(')'),
    assert(stone_at(4,3)),
    write('  Event: stone appears at '), write('('), write(4), write(','), write(2), writeln(')'),
    assert(stone_at(4,2)),
    ...
    agent_cycle(N, Intentions, Intentions3) :-
      N = 6,
        ...
        write('  Event: stone appears at '), write('('), write(9), write(','), write(2), writeln(')'),
        assert(stone_at(9,2)),
        ...
        agent_cycle(N, Intentions, Intentions3) :-
          N = 14,
            ...
            write('  Event: stone appears at '), write('('), write(1), write(','), write(3), writeln(')'),
            assert(stone_at(1,3)),
...
agent_cycle(N, Intentions, Intentions3) :-
  N = 28,
    ...
    write('  Event: stone appears at '), write('('), write(1), write(','), write(5), writeln(')'),
    assert(stone_at(1,5)),
    ...
    agent_cycle(N, Intentions, Intentions3) :-
      N = 33,
        ...
        write('  Event: stone appears at '), write('('), write(2), write(','), write(3), writeln(')'),
        assert(stone_at(2,3)),
        ...
        agent_cycle(N, Intentions, Intentions3) :-
          N = 38,
            ...
            write('  Event: stone appears at '), write('('), write(3), write(','), write(7), writeln(')'),
            assert(stone_at(3,7)),
            ...
            agent_cycle(N, Intentions, Intentions3) :-
              N = 46,
                ...
                write('  Event: stone appears at '), write('('), write(5), write(','), write(6), writeln(')'),
                assert(stone_at(5,6)),
                ...
                agent_cycle(N, Intentions, Intentions3) :-
                  N = 47,
                    ...
                    write('  Event: stone appears at '), write('('), write(8), write(','), write(7), writeln(')'),
                    assert(stone_at(8,7)),
